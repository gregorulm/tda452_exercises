...
the course homepage [1] provides easy access to all five sets
of exercises.

Lastly, while the code has been cleaned up, I left some "junk" in
them for pedagogical reasons, such as alternative definitions of
entire functions, or some refactored expressions.
